...
const pageDetector = (discordStatus) => {
    const content = {
        home: `Parsa Sorsori<br> Software Engineer<br><br><br>Hello there! My name is Parsa and I am a 20-year-old engineer from Iran. My interests lie in the field of computers and technologies, which is why I am currently studying Computer Engineering at QIAU. I discovered my passion for programming at the age of 11 and since then, I have been learning the C# language. At 16, I began exploring front-end web development and UI designing.<br><br><br><a href='projects/project.html'>/Projects</a><a href='contact/contact.html'>/Contact</a><a href='index.html'>/Home</a><br><br>`,
        ...
        projects: `this is projects page<br><br><br><a href='projects.html'>/Projects</a><a href='/contact/contact.html'>/Contact</a><a href='/index.html'>/Home</a><br><br>`
    };
